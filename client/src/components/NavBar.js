        ...
        <Grid item xs={8} sm={9} lg={10} >
          <nav position="static" color="default" >
            <Toolbar className="bg-white" className={classes.navbar}>
              ...
              <NavLink activeClassName="activeNavButton" to={checkType()} style={{ color: 'inherit', textDecoration: 'none', fontWeight: 500, color: 'white' }}><Button>
                <FontAwesomeIcon size="3x" icon={faEdit} className={classes.icon} />
              </Button></NavLink>

              <NavLink activeClassName="activeNavButton" to="/users/settings" style={{ textDecoration: "none", fontWeight: 500, color: 'white' }}><Button><FontAwesomeIcon size="3x" icon={faCog} className={classes.icon} /></Button></NavLink>
