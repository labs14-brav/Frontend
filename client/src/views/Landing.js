...
const cards = [
  ...
  },
  {
    ...
    label: "Documents",
    text:
      "Share information with your mediator using our file upload and viewing system."
  },
  {
    icon: SearchIcon,
    label: "Mediators",
    text:
      "Filter our qualified mediators based on criteria such as hourly rate, specialty, language, or experience in the field."
  },
  {
    icon: PaymentIcon,
    label: "Payment",
  ...
  },
  {
    ...
    label: "Accessibility",
    text:
      "Take your cases on-the-go through our mobile application, currently available on Android."
  },
  {
    icon: EmailIcon,
    label: "Notifications",
    text:
      "Never miss an update to your case. Brāv sends notifications to your email directly."
  }
];
        ...
        <div className="landingNav">
          ...
          <div className="how">
            ...
            <div className="alternativeMediation">
              <h6>
                Mediation is a great alternative to the formal judicial system.
                Our platform makes mediation even easier for users to manage
                conflict through the use of our online tools.
              </h6>
            </div>
